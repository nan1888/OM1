...
<Note>
**macOS Users**: Before running Spot, grant camera permissions to your terminal:

- Go to **System Settings** → **Privacy & Security** → **Camera**
- Enable access for **Terminal** (or **iTerm**/other terminal apps)
- Without this, Spot will run but won't receive camera input
