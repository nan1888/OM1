...
**Note:** **OM_API_KEY_ID** refers to the first 16 characters of your API key, excluding the **om_prod_** prefix.

**Example:**
- If your API key is: `om_prod_0123456789abcdef_xxxxxxxxxxxxxx`
- Then **OM_API_KEY_ID** is: `0123456789abcdef` (the 16 characters after `om_prod_`)
- And **OM_API_KEY** is the full key: `om_prod_0123456789abcdef_xxxxxxxxxxxxxx`

You can also find your **OM_API_KEY_ID** in the [portal](https://portal.openmind.org).
